# python batch.py --runner DataFlowRunner --project createder-1535612021236 --temp_location gs://ntest-pipeline/batch/temp --staging_location gs://ntest-pipeline/batch/stag --region asia-southeast1 --job_name drinkbeer
import apache_beam as beam
import argparse
from apache_beam.options.pipeline_options import PipelineOptions
from sys import argv

PROJECT_ID = 'createder-1535612021236'
...
if __name__ == '__main__':
    ...
    (p | 'ReadData' >> beam.io.ReadFromText('gs://ntest-pipeline/batch/beers.csv', skip_header_lines =1)
